...
#API_HTTP_PORT=8080;API_GRPC_PORT=8081;API_GRAPHQL_PORT=8082;API_HEALTHCHECK_PORT=8083;API_POSTGRESQL_URL=postgres://serhii:serhii@localhost:5432/api;API_POSTGRES_INIT_FILE=init.sql
