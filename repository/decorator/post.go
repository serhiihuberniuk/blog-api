...
func (d *RepositoryCacheDecorator) CreatePost(ctx context.Context, post *models.Post) error {
	...
	err = d.setItemToCache(ctx, post.ID, postObjectType, post)
	if err != nil {
...
func (d *RepositoryCacheDecorator) GetPost(ctx context.Context, postID string) (*models.Post, error) {
	...
	if d.redisCache.Exists(ctx, postObjectType+postID) {
		err := d.getItemFromCache(ctx, postID, postObjectType, &postFromCache)
		if err != nil {
	...
	err = d.setItemToCache(ctx, postID, postObjectType, post)
	if err != nil {
...
func (d *RepositoryCacheDecorator) DeletePost(ctx context.Context, postID string) error {
	...
	err = d.deleteItemFromCache(ctx, postID, postObjectType)
	if err != nil {
