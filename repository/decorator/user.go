...
func (d *RepositoryCacheDecorator) CreateUser(ctx context.Context, user *models.User) error {
	...
	err = d.setItemToCache(ctx, user.ID, userObjectType, user)
	if err != nil {
...
func (d *RepositoryCacheDecorator) GetUser(ctx context.Context, userID string) (*models.User, error) {
	...
	if d.redisCache.Exists(ctx, userObjectType+userID) {
		err := d.getItemFromCache(ctx, userID, userObjectType, &userFromCache)
		if err != nil {
			return nil, err
		}
	...
	err = d.setItemToCache(ctx, userID, userObjectType, user)
	if err != nil {
...
func (d *RepositoryCacheDecorator) DeleteUser(ctx context.Context, userID string) error {
	...
	err = d.deleteItemFromCache(ctx, userID, userObjectType)
	if err != nil {
